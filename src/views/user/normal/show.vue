  ...
  <el-card shadow="never" body-style="border: none;">
    ...
    <el-tabs v-model="activeName" >
      <el-tab-pane label="上传视频" name="first">
        <ProTable :columns="columns1" :toolButton="false" :initParam="initParam" :requestApi="getVideoList"></ProTable>
      </el-tab-pane>
      <el-tab-pane label="账户余额" name="second">
        <ProTable :columns="columns2" :toolButton="false" :initParam="initParam" :requestApi="getAccountList"></ProTable>
      </el-tab-pane>
    </el-tabs>
  </el-card>
</template>
